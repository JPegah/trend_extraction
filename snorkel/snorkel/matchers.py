    ...
    def _f(self, c): # This is executed each time that I try to match
        ...
        trend_kw = {
            ...
            "linear": ["reduce", "reduction",  "increase", "rise", "rising", "grow", "flat",
                       "drop", "gain", "downtrend", "plummet", "descend", "down", "decline", "downward", "fall"], # I removed the word "fall" from the candidates
...
class LexiconMatcher(RegexMatchLexicon):
    ...
    def __init__(self, *children, **kwargs):
        ...
        kwargs['rgx'] = 'Trend' # TODO: this should be converted to the set of our lexicon
